...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset('AdminLTE-2/plugins/iCheck/square/blue.css')); ?>">
...
<body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="<?php echo e(asset('AdminLTE-2/plugins/iCheck/icheck.min.js')); ?>"></script>
    <!-- Validator -->
...
<?php /**PATH C:\xampp\htdocs\pos\resources\views/layouts/auth.blade.php ENDPATH**/ ?>